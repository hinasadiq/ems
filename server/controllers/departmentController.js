...
// }catch(error){
//     return res.status(500).json({success:false,error:"edit department servor error"})
// }
// }
...
// }catch(error){
//     return res.status(500).json({success:false,error:"delete department servor error"})
// }
// } 
